...
> Note: You need to activate the virtual environment before running the python program. It is activated if there is a '(.venv)' at the beginning of your terminal prompt.
